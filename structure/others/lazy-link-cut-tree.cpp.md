...
data:
  ...
  attributes:
    document_title: Lazy-Link-Cut-Tree
    links: []
  bundledCode: "#line 1 \"structure/others/lazy-link-cut-tree.cpp\"\n/**\n * @brief\
    \ Lazy-Link-Cut-Tree\n */\ntemplate< typename T, typename E, typename F, typename\
    \ G, typename H, typename S >\nstruct LazyLinkCutTree {\n\nprivate:\n  F f;\n\
    \  G g;\n  H h;\n  S s;\n  E e0;\n\n  struct Node {\n    Node *l, *r, *p;\n  \
    \  T key, sum;\n    E lazy;\n    bool rev;\n    size_t sz;\n\n    explicit Node(const\
    \ T &v, const E &e) : key(v), sum(v), lazy(e), sz(1), rev(false),\n          \
    ...
    \ H, typename S >\nLazyLinkCutTree< T, E, F, G, H, S > get_lazy_link_cut_tree(const\
    \ F &f, const G &g, const H &h, const S &s, const E &e0) {\n  return {f, g, h,\
    \ s, e0};\n}\n"
  code: "/**\n * @brief Lazy-Link-Cut-Tree\n */\ntemplate< typename T, typename E,\
    \ typename F, typename G, typename H, typename S >\nstruct LazyLinkCutTree {\n\
    \nprivate:\n  F f;\n  G g;\n  H h;\n  S s;\n  E e0;\n\n  struct Node {\n    Node\
    \ *l, *r, *p;\n    T key, sum;\n    E lazy;\n    bool rev;\n    size_t sz;\n\n\
...
documentation_of: structure/others/lazy-link-cut-tree.cpp
layout: document
redirect_from:
- /library/structure/others/lazy-link-cut-tree.cpp
- /library/structure/others/lazy-link-cut-tree.cpp.html
