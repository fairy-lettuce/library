...
# :x: test/verify/yosupo-tree-diameter.test.cpp
...
* :question: <a href="../../../library/graph/tree/tree-diameter.cpp.html">Tree-Diameter(木の直径) <small>(graph/tree/tree-diameter.cpp)</small></a>
