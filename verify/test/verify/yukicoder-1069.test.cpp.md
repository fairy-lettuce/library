...
# :x: test/verify/yukicoder-1069.test.cpp
...
* :x: <a href="../../../library/graph/shortest-path/k-shortest-path.cpp.html">K-Shortest-Path <small>(graph/shortest-path/k-shortest-path.cpp)</small></a>
