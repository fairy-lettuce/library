...
data:
  ...
  code: "/**\n * @brief Bipartite-Flow(\u4E8C\u90E8\u30B0\u30E9\u30D5\u306E\u30D5\u30ED\
    ...
    \ n, size_t m) :\n      n(n), m(m), g(n), rg(m), match_l(n, -1), match_r(m, -1),\
    \ used(n), alive(n, 1), time_stamp(0), matched(false) {}\n\n  void add_edge(int\
    \ u, int v) {\n    g[u].push_back(v);\n    rg[v].emplace_back(u);\n  }\n\n  vector<\
...
layout: document
redirect_from:
- /library/graph/flow/bipartite-flow.cpp
- /library/graph/flow/bipartite-flow.cpp.html
